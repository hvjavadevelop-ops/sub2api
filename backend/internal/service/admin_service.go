...
type AdminService interface {
	...
	CreateTimedUserGrant(ctx context.Context, userID int64, input CreateTimedUserGrantInput) (*TimedUserGrant, error)
	ListTimedUserGrants(ctx context.Context, userID int64) ([]TimedUserGrant, error)
...
type adminServiceImpl struct {
	...
	timedGrantService    *TimedUserGrantService
...
func NewAdminService(
	...
	return &adminServiceImpl{
		...
		userRPMCache:         userRPMCache,
		billingCacheService:  billingCacheService,
		timedGrantService:    timedGrantService,
